...
const sections: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Multiple layers of encryption protect your data at all times:",
    ],
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "RBAC: Role-based permissions. Business Owners have full organization access. Employee sub-accounts are strictly scoped and locked to their assigned branch, preventing access to other branches' records.",
      ...
      "Biometric Auth: Fingerprint and face recognition processed natively by device OS security framework (iOS Keychain / Android Keystore).",
      ...
      "Session Management: JWT sessions expire after 7 days. Biometric sessions require re-authentication if credentials change. Logout explicitly invalidates tokens.",
  ...
  },
  {
    ...
    paragraphs: [
      `Certain risks fall outside our control. ${COMPANY} is NOT responsible for:`,
    ],
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Monitor Your Account: Review verification history and employee activity logs for unauthorized activity.",
      "Protect Your Device: Screen lock, no rooting/jailbreaking, official app stores only.",
      "Report Security Issues: Email nydevofficial@gmail.com for any concerns.",
    ],
  },
  {
    id: "incident",
        ...
        <div className="space-y-8">
          ...
          <div className="border-t border-[#c2c6d9]/25 py-10 text-center dark:border-white/5">
            ...
            <p className="mb-1 text-sm text-[#54647a] dark:text-[#c2c6d9]">
              We take all reports seriously. Contact our Security Team:
            </p>
            <a
          ...
          <div className="rounded-xl border border-[#c2c6d9]/25 bg-[#f2f3ff] p-6 text-center dark:border-white/5 dark:bg-white/3">
            <p className="text-xs leading-relaxed text-[#54647a] dark:text-[#c2c6d9]/70">
              This Security page is provided for informational transparency and
              does not constitute a contractual guarantee. For binding
              obligations, refer to our{" "}
              <Link to="/privacy" className="text-[#004bca] hover:underline">
                Privacy Policy
              </Link>{" "}
              and{" "}
              <Link to="/terms" className="text-[#004bca] hover:underline">
                Terms of Use
              </Link>
              .
            </p>
