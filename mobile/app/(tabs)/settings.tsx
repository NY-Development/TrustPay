...
export default function Settings() {
  ...
  const settingsItems = [
    { section: 'Security', items: [
      { id: 'biometrics', title: 'Biometric Login', icon: 'finger-print', type: 'switch', value: biometrics, onValueChange: setBiometrics },
  ...
  return (
    <View className="flex-1 bg-black">
      <ScrollView className="flex-1 pt-24 px-6">
        ...
        <View className="items-center pb-12">
          <Text className="text-zinc-600 text-sm font-medium">
            TrustPay v{Constants.expoConfig?.version ?? packageJson.version}
          </Text>
