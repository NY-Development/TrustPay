...
export default function VerifyEntry() {
  ...
  return (
    <View className="flex-1 bg-black px-6 pt-24">
      <Text className="text-white text-4xl font-bold mb-2">Verify Payment</Text>
      ...
      <View className="mt-auto mb-12 bg-[#12005E] rounded-3xl p-6 overflow-hidden border border-[#00E5FF]/20">
        <LinearGradient
