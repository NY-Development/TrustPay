  ...
  return (
    <View className="flex-1 bg-black">
      <ScrollView className="flex-1 px-6">
        <View className="pt-20 flex-row items-center mb-8">
        ...
        <View className="space-y-6">
          ...
          >
            {verifyMutation.isPending ? <ActivityIndicator color="black" className="mr-2" /> : <Ionicons name="checkmark-shield" size={24} color="black" className="mr-2" />}
