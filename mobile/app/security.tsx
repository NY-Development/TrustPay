...
const sections: SectionItem[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Database Encryption: MongoDB Atlas provides AES-256 encryption at rest for all stored data, including verification records, account details, and subscription information.',
  ...
  },
  {
    ...
    bullets: [
      'Role-Based Access Control (RBAC): The platform enforces role-based permissions. Regular users can only access their own data. Admin users have elevated privileges subject to audit logging.',
      ...
      'Admin Audit Trail: All administrative actions (user lookups, subscription modifications, verification reviews) are logged in immutable audit trails with timestamps, acting user, and action details.',
      'Session Management: JWT sessions expire after 7 days. Biometric sessions require re-authentication if the stored credential has been invalidated. Logout explicitly invalidates the current session token.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Brevo (Sendinblue) SMTP: Used exclusively for transactional emails (OTPs, password resets, alerts). Only the recipient email address and message content are shared. No marketing data is exchanged.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Data Loss on User Devices: If you lose your device, factory reset without backup, or uninstall the app, locally cached data (AI models, offline verification history) cannot be recovered from our servers.',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Monitor Your Account: Regularly review your verification history for any unauthorized activity. Report suspicious transactions immediately.',
